...
// be an array of migrations to be performed in order. NOTE that means for 'down'
// migration, you probably want to pass migrations in reverse order.
exports.apply_migrations = function(options, func, migrations, conn, register, callback)
{
  ...
  // XXX Disguise tx as a connection object.
  tx.adapter = conn.adapter;
